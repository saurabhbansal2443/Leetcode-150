...
const Questions = () => {
          ...
          >
            ...
            <div>
              ...
              <p className="text-gray-400 text-xs">
                Your logic is getting stronger. Keep going! 🚀
              </p>
            </div>
          </motion.div>
        ),
  ...
  const progressPercentage = Math.round(
    (completedIds.length / questionsData.length) * 100,
  );

  return (
    <div
      id="challenge"
      className="min-h-screen bg-[#0a0a0c] pb-20 px-4 sm:px-6 lg:px-8 selection:bg-indigo-500/30"
    >
      {/* Progress Dashboard */}
      <motion.div
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          <div className="lg:col-span-2 bg-gradient-to-br from-indigo-600/10 to-transparent border border-white/10 rounded-[2.5rem] p-8 flex flex-col md:flex-row items-center justify-between gap-8 relative overflow-hidden group">
            ...
            <div className="z-10">
              ...
              <h2 className="text-4xl font-black text-white mb-6">
                Top 150 <span className="text-indigo-500">Mastery</span>
              </h2>
              ...
              <div className="flex gap-4">
                ...
                <div className="bg-white/5 backdrop-blur-md border border-white/10 px-5 py-3 rounded-2xl">
                  ...
                  <p className="text-2xl font-black text-gray-400">
                    {questionsData.length - completedIds.length}
                  </p>
                </div>
              </div>
            </div>
          ...
          <div className="bg-[#0e0e12] border border-white/10 rounded-[2.5rem] p-8 flex flex-col justify-center items-center text-center group">
            ...
            <p className="text-gray-500 text-sm leading-relaxed">
              Consistency is the secret sauce. Solve at least one problem daily!
            </p>
          </div>
        </div>
      </motion.div>
            ...
            >
              <div className="p-7">
                <div className="flex justify-between items-start mb-6">
                  <span
                    className={`text-[10px] font-black tracking-widest px-3 py-1 rounded-full ${isDone ? "bg-indigo-500 text-white" : "bg-white/5 text-gray-500"}`}
                  >
                    Question - {q.id}
                  </span>
                  <button
                ...
                <h3
                  className={`text-xl font-bold mb-8 transition-all duration-500 leading-tight ${
                    isDone
